...
<body>
    ...
    <div class="menu">
        ...
        <ul class="navbar">
            <li class="navbar__link"><a href="book_list">BOOK LIST</a></li>
            <li class="navbar__link"><a href="book_search.jsp">SEARCH BOOK</a></li>
            <li class="navbar__link"><a href="categoryList.jsp">CATEGORY LIST</a></li>
        </ul>
